...
File: RQ3_TAL_max_prior_pseudo_loc_statistic_spv.py
Date : 2022/11/24 17:11
Author : njumy
HomePage : https://github.com/meiyuanqing
Email : dg1533019@smail.nju.edu.cn

与RQ3_TAL_middle_prior_pseudo_loc_statistic_spv.py类似,但每次取投票得分的最大值用于主动学习
        ...
        for name in versions_sorted:
            ...
            for i in range(percent_5):
                ...
                for row in range(len(df_name)):
                    if df_name.loc[row, 'pred_20_score'] == score_list[0]:
...
if __name__ == '__main__':
    ...
    result_Directory = "/home/myq/talcvdp/active_learning_max_prior_pseudo_loc_statistic/"
