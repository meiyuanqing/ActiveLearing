...
File: reviewer_2_RQ_3_tal_spv_on_apache.py
...
回复第二个评审人的第三个问题的代码
Question 3:
Third, it is very nice to see the whole replica packages the authors provided. However, the experiment data inside
seems similar, most of them only have 3 versions, I wonder if TAL can still achieve great performance when dealing
with more versions of more projects.

参考tal_spv.py，将数据集换成APACHE的项目，版本数多于三个
"""
...
# 'LCOM1', 'LCOM2', 'LCOM3', 'ICH', 'NHD', 'OCAIC', 'OCMIC', 'OMMIC', 'CBO', 'DAC', 'ICP', 'MPC',
...
def do_predction(i, name_previous, name, metrics_positvie, iter_pearson, iter_t, df_test, df_alt):
    ...
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_precision', 'last_version': name_previous, 'current_version': name[:-4],
         ...
         'LCOM1': iter_t_precision['LCOM1'], 'LCOM2': iter_t_precision['LCOM2'], 'LCOM3': iter_t_precision['LCOM3'],
         'ICH': iter_t_precision['ICH'], 'NHD': iter_t_precision['NHD'], 'OCAIC': iter_t_precision['OCAIC'],
         'OCMIC': iter_t_precision['OCMIC'], 'OMMIC': iter_t_precision['OMMIC'], 'CBO': iter_t_precision['CBO'],
         'DAC': iter_t_precision['DAC'], 'ICP': iter_t_precision['ICP'], 'MPC': iter_t_precision['MPC'],
         'NIHICP': iter_t_precision['NIHICP'], 'RFC': iter_t_precision['RFC'], 'NMA': iter_t_precision['NMA'],
         "NA": iter_t_precision["NA"], "NAIMP": iter_t_precision["NAIMP"], "NM": iter_t_precision["NM"],
         "NMIMP": iter_t_precision["NMIMP"], "NumPara": iter_t_precision["NumPara"], "SLOC": iter_t_precision["SLOC"],
         "stms": iter_t_precision["stms"]}, ignore_index=True)
    # store recall
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_recall', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_recall['LCOM1'], 'LCOM2': iter_t_recall['LCOM2'], 'LCOM3': iter_t_recall['LCOM3'],
         'ICH': iter_t_recall['ICH'], 'NHD': iter_t_recall['NHD'], 'OCAIC': iter_t_recall['OCAIC'],
         'OCMIC': iter_t_recall['OCMIC'], 'OMMIC': iter_t_recall['OMMIC'], 'CBO': iter_t_recall['CBO'],
         'DAC': iter_t_recall['DAC'], 'ICP': iter_t_recall['ICP'], 'MPC': iter_t_recall['MPC'],
         'NIHICP': iter_t_recall['NIHICP'], 'RFC': iter_t_recall['RFC'], 'NMA': iter_t_recall['NMA'],
         "NA": iter_t_recall["NA"], "NAIMP": iter_t_recall["NAIMP"], "NM": iter_t_recall["NM"],
         "NMIMP": iter_t_recall["NMIMP"], "NumPara": iter_t_recall["NumPara"], "SLOC": iter_t_recall["SLOC"],
         "stms": iter_t_recall["stms"]}, ignore_index=True)
    # store auc
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_auc', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_auc['LCOM1'], 'LCOM2': iter_t_auc['LCOM2'], 'LCOM3': iter_t_auc['LCOM3'],
         'ICH': iter_t_auc['ICH'], 'NHD': iter_t_auc['NHD'], 'OCAIC': iter_t_auc['OCAIC'],
         'OCMIC': iter_t_auc['OCMIC'], 'OMMIC': iter_t_auc['OMMIC'], 'CBO': iter_t_auc['CBO'],
         'DAC': iter_t_auc['DAC'], 'ICP': iter_t_auc['ICP'], 'MPC': iter_t_auc['MPC'],
         'NIHICP': iter_t_auc['NIHICP'], 'RFC': iter_t_auc['RFC'], 'NMA': iter_t_auc['NMA'],
         "NA": iter_t_auc["NA"], "NAIMP": iter_t_auc["NAIMP"], "NM": iter_t_auc["NM"],
         "NMIMP": iter_t_auc["NMIMP"], "NumPara": iter_t_auc["NumPara"], "SLOC": iter_t_auc["SLOC"],
         "stms": iter_t_auc["stms"]}, ignore_index=True)
    # store auc_var
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_auc_var', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_auc_var['LCOM1'], 'LCOM2': iter_t_auc_var['LCOM2'], 'LCOM3': iter_t_auc_var['LCOM3'],
         'ICH': iter_t_auc_var['ICH'], 'NHD': iter_t_auc_var['NHD'], 'OCAIC': iter_t_auc_var['OCAIC'],
         'OCMIC': iter_t_auc_var['OCMIC'], 'OMMIC': iter_t_auc_var['OMMIC'], 'CBO': iter_t_auc_var['CBO'],
         'DAC': iter_t_auc_var['DAC'], 'ICP': iter_t_auc_var['ICP'], 'MPC': iter_t_auc_var['MPC'],
         'NIHICP': iter_t_auc_var['NIHICP'], 'RFC': iter_t_auc_var['RFC'], 'NMA': iter_t_auc_var['NMA'],
         "NA": iter_t_auc_var["NA"], "NAIMP": iter_t_auc_var["NAIMP"], "NM": iter_t_auc_var["NM"],
         "NMIMP": iter_t_auc_var["NMIMP"], "NumPara": iter_t_auc_var["NumPara"], "SLOC": iter_t_auc_var["SLOC"],
         "stms": iter_t_auc_var["stms"]}, ignore_index=True)
    # store gm
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_gm', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_gm['LCOM1'], 'LCOM2': iter_t_gm['LCOM2'], 'LCOM3': iter_t_gm['LCOM3'],
         'ICH': iter_t_gm['ICH'], 'NHD': iter_t_gm['NHD'], 'OCAIC': iter_t_gm['OCAIC'],
         'OCMIC': iter_t_gm['OCMIC'], 'OMMIC': iter_t_gm['OMMIC'], 'CBO': iter_t_gm['CBO'],
         'DAC': iter_t_gm['DAC'], 'ICP': iter_t_gm['ICP'], 'MPC': iter_t_gm['MPC'],
         'NIHICP': iter_t_gm['NIHICP'], 'RFC': iter_t_gm['RFC'], 'NMA': iter_t_gm['NMA'],
         "NA": iter_t_gm["NA"], "NAIMP": iter_t_gm["NAIMP"], "NM": iter_t_gm["NM"],
         "NMIMP": iter_t_gm["NMIMP"], "NumPara": iter_t_gm["NumPara"], "SLOC": iter_t_gm["SLOC"],
         "stms": iter_t_gm["stms"]}, ignore_index=True)
    # store f1
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_f1', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_f1['LCOM1'], 'LCOM2': iter_t_f1['LCOM2'], 'LCOM3': iter_t_f1['LCOM3'],
         'ICH': iter_t_f1['ICH'], 'NHD': iter_t_f1['NHD'], 'OCAIC': iter_t_f1['OCAIC'],
         'OCMIC': iter_t_f1['OCMIC'], 'OMMIC': iter_t_f1['OMMIC'], 'CBO': iter_t_f1['CBO'],
         'DAC': iter_t_f1['DAC'], 'ICP': iter_t_f1['ICP'], 'MPC': iter_t_f1['MPC'],
         'NIHICP': iter_t_f1['NIHICP'], 'RFC': iter_t_f1['RFC'], 'NMA': iter_t_f1['NMA'],
         "NA": iter_t_f1["NA"], "NAIMP": iter_t_f1["NAIMP"], "NM": iter_t_f1["NM"],
         "NMIMP": iter_t_f1["NMIMP"], "NumPara": iter_t_f1["NumPara"], "SLOC": iter_t_f1["SLOC"],
         "stms": iter_t_f1["stms"]}, ignore_index=True)
    # store bpp
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_bpp', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_bpp['LCOM1'], 'LCOM2': iter_t_bpp['LCOM2'], 'LCOM3': iter_t_bpp['LCOM3'],
         'ICH': iter_t_bpp['ICH'], 'NHD': iter_t_bpp['NHD'], 'OCAIC': iter_t_bpp['OCAIC'],
         'OCMIC': iter_t_bpp['OCMIC'], 'OMMIC': iter_t_bpp['OMMIC'], 'CBO': iter_t_bpp['CBO'],
         'DAC': iter_t_bpp['DAC'], 'ICP': iter_t_bpp['ICP'], 'MPC': iter_t_bpp['MPC'],
         'NIHICP': iter_t_bpp['NIHICP'], 'RFC': iter_t_bpp['RFC'], 'NMA': iter_t_bpp['NMA'],
         "NA": iter_t_bpp["NA"], "NAIMP": iter_t_bpp["NAIMP"], "NM": iter_t_bpp["NM"],
         "NMIMP": iter_t_bpp["NMIMP"], "NumPara": iter_t_bpp["NumPara"], "SLOC": iter_t_bpp["SLOC"],
         "stms": iter_t_bpp["stms"]}, ignore_index=True)
    # store fpr
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_fpr', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_fpr['LCOM1'], 'LCOM2': iter_t_fpr['LCOM2'], 'LCOM3': iter_t_fpr['LCOM3'],
         'ICH': iter_t_fpr['ICH'], 'NHD': iter_t_fpr['NHD'], 'OCAIC': iter_t_fpr['OCAIC'],
         'OCMIC': iter_t_fpr['OCMIC'], 'OMMIC': iter_t_fpr['OMMIC'], 'CBO': iter_t_fpr['CBO'],
         'DAC': iter_t_fpr['DAC'], 'ICP': iter_t_fpr['ICP'], 'MPC': iter_t_fpr['MPC'],
         'NIHICP': iter_t_fpr['NIHICP'], 'RFC': iter_t_fpr['RFC'], 'NMA': iter_t_fpr['NMA'],
         "NA": iter_t_fpr["NA"], "NAIMP": iter_t_fpr["NAIMP"], "NM": iter_t_fpr["NM"],
         "NMIMP": iter_t_fpr["NMIMP"], "NumPara": iter_t_fpr["NumPara"], "SLOC": iter_t_fpr["SLOC"],
         "stms": iter_t_fpr["stms"]}, ignore_index=True)
    # store tnr
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_tnr', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_tnr['LCOM1'], 'LCOM2': iter_t_tnr['LCOM2'], 'LCOM3': iter_t_tnr['LCOM3'],
         'ICH': iter_t_tnr['ICH'], 'NHD': iter_t_tnr['NHD'], 'OCAIC': iter_t_tnr['OCAIC'],
         'OCMIC': iter_t_tnr['OCMIC'], 'OMMIC': iter_t_tnr['OMMIC'], 'CBO': iter_t_tnr['CBO'],
         'DAC': iter_t_tnr['DAC'], 'ICP': iter_t_tnr['ICP'], 'MPC': iter_t_tnr['MPC'],
         'NIHICP': iter_t_tnr['NIHICP'], 'RFC': iter_t_tnr['RFC'], 'NMA': iter_t_tnr['NMA'],
         "NA": iter_t_tnr["NA"], "NAIMP": iter_t_tnr["NAIMP"], "NM": iter_t_tnr["NM"],
         "NMIMP": iter_t_tnr["NMIMP"], "NumPara": iter_t_tnr["NumPara"], "SLOC": iter_t_tnr["SLOC"],
         "stms": iter_t_tnr["stms"]}, ignore_index=True)
    # store er
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_er', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_er['LCOM1'], 'LCOM2': iter_t_er['LCOM2'], 'LCOM3': iter_t_er['LCOM3'],
         'ICH': iter_t_er['ICH'], 'NHD': iter_t_er['NHD'], 'OCAIC': iter_t_er['OCAIC'],
         'OCMIC': iter_t_er['OCMIC'], 'OMMIC': iter_t_er['OMMIC'], 'CBO': iter_t_er['CBO'],
         'DAC': iter_t_er['DAC'], 'ICP': iter_t_er['ICP'], 'MPC': iter_t_er['MPC'],
         'NIHICP': iter_t_er['NIHICP'], 'RFC': iter_t_er['RFC'], 'NMA': iter_t_er['NMA'],
         "NA": iter_t_er["NA"], "NAIMP": iter_t_er["NAIMP"], "NM": iter_t_er["NM"],
         "NMIMP": iter_t_er["NMIMP"], "NumPara": iter_t_er["NumPara"], "SLOC": iter_t_er["SLOC"],
         "stms": iter_t_er["stms"]}, ignore_index=True)
    # store accuracy
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_accuracy', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_accuracy['LCOM1'], 'LCOM2': iter_t_accuracy['LCOM2'], 'LCOM3': iter_t_accuracy['LCOM3'],
         'ICH': iter_t_accuracy['ICH'], 'NHD': iter_t_accuracy['NHD'], 'OCAIC': iter_t_accuracy['OCAIC'],
         'OCMIC': iter_t_accuracy['OCMIC'], 'OMMIC': iter_t_accuracy['OMMIC'], 'CBO': iter_t_accuracy['CBO'],
         'DAC': iter_t_accuracy['DAC'], 'ICP': iter_t_accuracy['ICP'], 'MPC': iter_t_accuracy['MPC'],
         'NIHICP': iter_t_accuracy['NIHICP'], 'RFC': iter_t_accuracy['RFC'], 'NMA': iter_t_accuracy['NMA'],
         "NA": iter_t_accuracy["NA"], "NAIMP": iter_t_accuracy["NAIMP"], "NM": iter_t_accuracy["NM"],
         "NMIMP": iter_t_accuracy["NMIMP"], "NumPara": iter_t_accuracy["NumPara"], "SLOC": iter_t_accuracy["SLOC"],
         "stms": iter_t_accuracy["stms"]}, ignore_index=True)
    # store error_rate
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_error_rate', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_error_rate['LCOM1'], 'LCOM2': iter_t_error_rate['LCOM2'], 'LCOM3': iter_t_error_rate['LCOM3'],
         'ICH': iter_t_error_rate['ICH'], 'NHD': iter_t_error_rate['NHD'], 'OCAIC': iter_t_error_rate['OCAIC'],
         'OCMIC': iter_t_error_rate['OCMIC'], 'OMMIC': iter_t_error_rate['OMMIC'], 'CBO': iter_t_error_rate['CBO'],
         'DAC': iter_t_error_rate['DAC'], 'ICP': iter_t_error_rate['ICP'], 'MPC': iter_t_error_rate['MPC'],
         'NIHICP': iter_t_error_rate['NIHICP'], 'RFC': iter_t_error_rate['RFC'], 'NMA': iter_t_error_rate['NMA'],
         "NA": iter_t_error_rate["NA"], "NAIMP": iter_t_error_rate["NAIMP"], "NM": iter_t_error_rate["NM"],
         "NMIMP": iter_t_error_rate["NMIMP"], "NumPara": iter_t_error_rate["NumPara"], "SLOC": iter_t_error_rate["SLOC"],
         "stms": iter_t_error_rate["stms"]}, ignore_index=True)
    # store mcc
    df_alt = df_alt.append(
        {'iteration': str(i) + '_t_mcc', 'last_version': name_previous, 'current_version': name[:-4],
         'Sample_size': len(df_test),
         'LCOM1': iter_t_mcc['LCOM1'], 'LCOM2': iter_t_mcc['LCOM2'], 'LCOM3': iter_t_mcc['LCOM3'],
         'ICH': iter_t_mcc['ICH'], 'NHD': iter_t_mcc['NHD'], 'OCAIC': iter_t_mcc['OCAIC'],
         'OCMIC': iter_t_mcc['OCMIC'], 'OMMIC': iter_t_mcc['OMMIC'], 'CBO': iter_t_mcc['CBO'],
         'DAC': iter_t_mcc['DAC'], 'ICP': iter_t_mcc['ICP'], 'MPC': iter_t_mcc['MPC'],
         'NIHICP': iter_t_mcc['NIHICP'], 'RFC': iter_t_mcc['RFC'], 'NMA': iter_t_mcc['NMA'],
         "NA": iter_t_mcc["NA"], "NAIMP": iter_t_mcc["NAIMP"], "NM": iter_t_mcc["NM"],
         "NMIMP": iter_t_mcc["NMIMP"], "NumPara": iter_t_mcc["NumPara"], "SLOC": iter_t_mcc["SLOC"],
         "stms": iter_t_mcc["stms"]}, ignore_index=True)
...
def active_learning_mvs_middle(working_dir, result_dir):
    ...
    for project_t in projects_t:
        ...
        for name in versions_sorted:
            ...
            # store the results of active_learning_semisupervised：'f1_value', 'gm_value', 'bpp_value'
            df_als = pd.DataFrame(
                columns=['iteration', 'last_version', 'current_version', 'Sample_size', 'LCOM1', 'LCOM2', 'LCOM3',
                         'ICH', 'NHD', 'OCAIC', 'OCMIC', 'OMMIC', 'CBO', 'DAC', 'ICP', 'MPC',
                         'NIHICP', 'RFC', "NMA", "NA", "NAIMP", "NM", "NMIMP", "NumPara", "SLOC", "stms"], dtype=object)
            ...
            for i in range(percent_5):
                ...
                for metric in metrics_22:
                    ...
                    df_name_previous = df_name_previous[~df_name_previous['SLOC'].isin([0])].reset_index(drop=True)
                ...
                df_name['pred_20_score'] = df_name.apply(lambda x: x['pred_20'] + (1 / x['SLOC']), axis=1)
                ...
                df_name_temp = df_name.loc[:, metrics_22 + ['bug', "bugBinary", 'pred_20', 'pred_20_score',
                                                            'iter', 'iter_bug']].copy()
                ...
                df_training = df_iter.loc[:, metrics_22 + ['iter_bug']]
                df_training = df_training.append(df_manual_labels.loc[:, metrics_22 + ['iter_bug']]).reset_index(
                    drop=True)
                df_training = df_training.append(df_name_previous.loc[:, metrics_22 + ['iter_bug']]).reset_index(
                    drop=True)
                ...
                df_als = do_predction(i, name_previous, name, metrics_22, iter_pearson, iter_t,
...
if __name__ == '__main__':
    ...
    work_Directory = "/home/myq/talcvdp/pyData/data_defects_java_training/"
    result_Directory = "/home/myq/talcvdp/active_learning_middle_prior_pseudo_on_pyData/"
